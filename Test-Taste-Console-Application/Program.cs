...
namespace Test_Taste_Console_Application
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            await RunServiceOperationsAsync(serviceCollection);
        }

        private static async Task RunServiceOperationsAsync(IServiceCollection serviceCollection)
        {
            ...
            try
            {
                await screenOutputService.OutputAllPlanetsAndTheirAverageMoonGravityToConsole();
                screenOutputService.OutputAllMoonsAndTheirMassToConsole();
                await screenOutputService.OutputAllPlanetsAndTheirMoonsToConsole();
            }
